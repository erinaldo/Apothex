...
namespace Reports
{
    ...
    public class RptSalesOrderDetail : StiReport
    {
        ...
        public StiPrinterSettings RptSalesOrderDetail_PrinterSettings;
        ...
        {
            e.Value = DataSP_GetSalesOrderDetail_SaleUnitPriceDiscount.TextFormat.Format(CheckExcelValue(sender, SP_GetSalesOrderDetail.LinePriceDiscount));
        }

        public void DataSP_GetSalesOrderDetail_SaleLineTotal__GetValue(object sender, StiGetValueEventArgs e)
        {
            e.Value = DataSP_GetSalesOrderDetail_SaleLineTotal.TextFormat.Format(CheckExcelValue(sender, SP_GetSalesOrderDetail.LineTotal));
        }

        public void Text9__GetValue(object sender, StiGetValueEventArgs e)
        {
            e.Value = ToString(sender, SP_GetSalesOrderDetail.MedicamentName, true) + ToString(sender, IIF(SP_GetSalesOrderDetail.Size != "", " " + SP_GetSalesOrderDetail.Size, ""), true) + ToString(sender, IIF(SP_GetSalesOrderDetail.SizeUnitMeasureCode != "", " " + SP_GetSalesOrderDetail.SizeUnitMeasureCode, ""), true);
        }
        ...
        {
            e.Value = "#%#{Sum(SP_GetSalesOrderDetail.LineTotal)}";
            e.StoreToPrinted = true;
        }
        ...
        {
            e.Value = "პროდუქცია: " + ToString(sender, Format("{0:N2}", SP_GetSalesOrderDetail.SP_GetSalesOrderHeader.SubTotal), true) + " " + ToString(sender, SP_GetSalesOrderDetail.SP_GetSalesOrderHeader.CurrencyCode, true) + "\r\nტრანსპორტირება: " + ToString(sender, Format("{0:N2}", SP_GetSalesOrderDetail.SP_GetSalesOrderHeader.Freight), true) + " " + ToString(sender, SP_GetSalesOrderDetail.SP_GetSalesOrderHeader.CurrencyCode, true) + "\r\nსაგადასახადო: " + ToString(sender, Format("{0:N2}", SP_GetSalesOrderDetail.SP_GetSalesOrderHeader.TaxAmt), true) + " " + ToString(sender, SP_GetSalesOrderDetail.SP_GetSalesOrderHeader.CurrencyCode, true) + "\r\nთანხა სულ: " + ToString(sender, Format("{0:N2}", SP_GetSalesOrderDetail.SP_GetSalesOrderHeader.TotalDue), true) + " " + ToString(sender, SP_GetSalesOrderDetail.SP_GetSalesOrderHeader.CurrencyCode, true);
        }
        ...
        public void RptSalesOrderDetail_Rendering(object sender, EventArgs e)
        {
            /*int page2RowCount = 7;
...
if (SP_GetSalesOrderDetail.Count > page2RowCount)
	...
	Page1.Enabled = false;*/
        ...
        public void DataSP_GetSalesOrderDetail__Rendering(object sender, EventArgs e)
        {
            ...
            Text4_Sum.CalcItem(SP_GetSalesOrderDetail.LineTotal);
        }
        ...
        private void InitializeComponent()
        {
            ...
            ReportAlias = "Rpt Sales Order Detail";
            ReportAuthor = "Programmer.GE";
            // 
            // ReportChanged
            // 
            ReportChanged = new DateTime(2010, 10, 13, 22, 45, 6, 663);
            // 
            // ReportCreated
            // 
            ReportCreated = new DateTime(2009, 2, 11, 22, 7, 37, 0);
            ReportDescription = "გაყიდვის დეტალური რეპორტი";
            ReportFile = "D:\\User\\Documents\\Projects\\Apothex\\Source\\Class Library\\Apothex.Reporting\\Sales\\R" +
"ptSalesOrderDetail.mrt";
            ReportGuid = "fac41342b10b47d0ad579056b5d354f5";
            ReportName = "RptSalesOrderDetail";
            ...
            DataSP_GetSalesOrderHeader.DataSourceName = "SP_GetRptSalesOrderHeader";
            ...
            DataSP_GetSalesOrderDetail_ValidDate.HorAlignment = StiTextHorAlignment.Center;
            ...
            // 
            Text9 = new StiText();
            Text9.ClientRectangle = new RectangleD(1, 0, 7.4, 0.8);
            Text9.Name = "Text9";
            ...
            DataSP_GetSalesOrderDetail.DataRelationName = null;
            DataSP_GetSalesOrderDetail.Guid = null;
            DataSP_GetSalesOrderDetail.Interaction = null;
            DataSP_GetSalesOrderDetail.MasterComponent = null;
            // 
            ...
            RptSalesOrderDetail_PrinterSettings = new StiPrinterSettings();
            Rendering += new EventHandler(RptSalesOrderDetail_Rendering);
            PrinterSettings = RptSalesOrderDetail_PrinterSettings;
            Page1.Report = this;
            ...
            SP_GetSalesOrderDetail.Columns.AddRange(new[] {
                        ...
                        new StiDataColumn("Action", "Action", "Action", typeof(int)),
                        new StiCalcDataColumn("LinePriceDiscount", "LinePriceDiscount", typeof(decimal))});
        ...
        public class SP_GetSalesOrderDetailDataSource : StiDataTableSource
        {
            ...
            public virtual decimal LinePriceDiscount
            {
                get
                {
                    return ((RptSalesOrderDetail)(Dictionary.Report)).GetSP_GetSalesOrderDetail_LinePriceDiscount();
                }
            }
